############################################
### V4 processing for wild nase
### from Guivier et al., 2019
### Lou LaMartina, started September 1, 2020
############################################
...
setwd("~/Desktop/Lab/Projects/Aeromonas/Seafood/Nase")
...
# filter based on quality and read length (chose 230 based on quality profiles)
...
ncol(Sequence_table)               # [1] 771
ncol(Sequence_table_nochim)        # [1] 745
ncol(Sequence_table) - 
       ncol(Sequence_table_nochim) # [1] 26
