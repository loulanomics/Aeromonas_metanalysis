#######################################
### V4 processing hospital effluent
...
setwd("~/Desktop/Aeromonas/Effluent")
...
fastqFs <- sort(list.files(pathF, pattern = "1.fastq", full.names = TRUE))
fastqRs <- sort(list.files(pathR, pattern = "2.fastq", full.names = TRUE))
