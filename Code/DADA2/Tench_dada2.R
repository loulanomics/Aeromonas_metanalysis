############################################
### V4 processing for Tench
### from Dulski et al., 2020
...
setwd("~/Desktop/Lab/Projects/Aeromonas/Seafood/Tench")
...
ncol(Sequence_table)               # [1] 9892 before
ncol(Sequence_table_nochim)        # [1] 6831 after
ncol(Sequence_table) - 
       ncol(Sequence_table_nochim) # [1] 3061 removed
