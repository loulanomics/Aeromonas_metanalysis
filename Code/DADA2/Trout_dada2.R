############################################
### V4 processing for Trout
### from Vasemägi et al., 2017
...
setwd("~/Desktop/Lab/Projects/Aeromonas/Seafood/Trout")
...
# plotting all of them since there aren't many
...
# save error plots
ggsave("./Plots/errorF.pdf", plot = errorF, device = "pdf", width = 12, height = 8, units = "in")
ggsave("./Plots/errorR.pdf", plot = errorR, device = "pdf", width = 12, height = 8, units = "in")
...
ncol(Sequence_table)               # [1] 29702 before
ncol(Sequence_table_nochim)        # [1] 10501 after
ncol(Sequence_table) - 
       ncol(Sequence_table_nochim) # [1] 19201 removed
